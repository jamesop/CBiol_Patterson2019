function [cellTotPar,matCellGrowth]=cellAdderTotDivSim(growthRate,numCells,simTime,numAdd,numNoise,meanDivLen)
...
for i=1:simTime;
    ...
    matDivSize(currCellEnd==1)=matCellGrowth((currCellEnd==1),1)+normrnd(numAdd,numNoise,sum(currCellEnd==1),1);
